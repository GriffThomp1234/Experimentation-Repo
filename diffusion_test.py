...
from mavis_refactored.dp_utils.datasets import DiffusionPolicyVisionDataset
from mavis_refactored.dp_utils.network import create_nets
from mavis_mujoco.mavis_mujoco_gym.utils.create_env import create_env
from Spiking_UNet.model.snn_model.U_Net import SinusoidalPosEmb
...
# # Find an available port and set it as MASTER_PORT
...
env_configs = {
    ...
    "goal_complete_reward": 500.0,
    "gripper_finger_contact_reward": 0.035,
    "block_z_penalty_coefficient": 1.0,
    "use_viewpoint_penalty": True,
    "distance_penalty_coefficient": 0.35,
    "viewpoint_selection_penalty_coefficient": 0.15,
    "rs_cam_distance_penalty_triggering_lower_bound": 0.15,
    "rs_cam_distance_penalty_triggering_upper_bound": 1.0,
    "block_z_no_penalty_lower_bound": 0.1,
    "block_z_no_penalty_upper_bound": 0.3,
    "target_in_the_air": False,
    "random_block_pos": True,
    "random_target_pos": False
}

dataset_dir = "/home/griffin/projects/SNN_TEST/mavis_project/mavis_refactored/pick_and_place_vision_random"
state_key = "lookat_space_euler_state_obs"
action_key = "lookat_space_euler_action"
normalize_rgb_images = True

training_session_name = "realworld_drawer_assembling/lookat_euler_space_num_demo_rollouts_201"
...
if __name__ == "__main__":
    ...
    print(f"Sampled RGB images shape: {sampled_rgb_images.shape}")
    print(f"Sampled state shape: {sampled_state.shape}")
    print(f"Sampled action shape: {sampled_action.shape}")
    print(f"Sampled reward: {sampled_reward}")
    _, channels, height, width = sampled_rgb_images.shape
